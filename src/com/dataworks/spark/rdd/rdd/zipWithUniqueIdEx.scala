...
/**
  ...
  */
object zipWithUniqueIdEx {

  def main(args: Array[String]): Unit = {
    val conf: SparkConf = new SparkConf().setAppName("zipWithUniqueIdEx").setMaster("local")
  ...
  def zipIntStrPartn(sc: SparkContext) = {
    ...
    val zippedRdd: RDD[(String, Long)] = flattenedRdd.zipWithUniqueId()
